                        ...
                        <div class="tab-content">
                            ...
                            <div id="lg1" class="tab-pane active">
                                <div class="login-form-container">
                                    ...
                                    <form class="text-center" action="{{ url('/reset-password') }}" method="post">
                                        @csrf
                                        <input type="hidden" name="token" value="{{request()->route('token')}}">
                                        <div class="input mb-2">
                                            <input name="email" value="{{ $request->email }}" placeholder="ایمیل"
                                                type="email">
                                            @error('email')
                                        ...
                                        <div class="input mb-2"> <input  type="password" name="password"
                                            ...
                                            <div class="input mb-2"> <input  type="password" name="password_confirmation"
                                        ...
                                        <button class="btn btn-outline-info" id="timer-btn" type="submit"> تغییر رمز
                                        </button>
                                    </form>
                                </div>
                            </div>
